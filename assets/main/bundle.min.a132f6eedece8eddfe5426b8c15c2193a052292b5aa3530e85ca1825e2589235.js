(() => {
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\snackbar\index.ts
  var Snackbar = class {
    constructor() {
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\actions-panel\index.ts
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\app\index.ts
  var App = class {
    constructor() {
  ...
  var params_default = { analytics: null, archive: { paginate: 20 }, backgroundimage: ["/images/bg-light.webp", "/images/eclipse.png"], baseURL: "http://localhost:1313/", brand: "Yibel's Blog", breadcrumb: true, breadcrumbdivider: "", carouselpostcount: 3, categorycount: 10, codeblock: { linenos: false, maxlines: 8 }, color: "auto", contact: { endpoint: "https://getform.io/f/56041c81-9e03-4c24-b9c5-61238854d4cd" }, counttaxonomyposts: true, creativecommons: null, customcss: null, customjs: null, dateformat: ":date_long", description: "Yibel's personal blog", diagram: true, featuredpostcount: 5, fixedheader: false, fontsize: null, fullwidth: false, giscus, googleadsense: null, keywords: "Record, Blog", logo: "images/logo.webp", mainsections: ["blog", "posts", "news"], palette: "purple", palettes: ["blue", "blue-gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 3, post: { numberifyheadings: false, numberifyheadingsseparator: "." }, postdate: true, poweredby: true, pwa: { manifest: { short_name: "Yibel's Blog" } }, readingtime: true, recentpostcount: 5, relatedpostcount: 10, repo: { branch: "main", url: "https://github.com/razonyang/hugo-theme-bootstrap-skeleton" }, reward: { alipay: "images/reward/alipay.png", wechat: "images/reward/wechat.png" }, search: { fuse: { threshold: 0.1 }, paginate: 5 }, searchbar: true, seriescount: 10, sidebar: null, sidebartaxonomies: ["series", "categories", "tags", "authors"], siteverification: { baidu: null, baiduunion: null, bing: null, google: null, shenma: null, so: null, sogou: null }, social: { email: "user@domain.tld", github: "https://github.com/y1bel" }, tagcount: 10, taxonomypaginate: 10, taxonomypostcount: 10, titlecase: true, titleseparator: "|", tocwordcount: 10, topappbar: { coloredindark: true, colortoggle: true, social: { github: "https://github.com/y1bel", patreon: null, paypal: null } }, viewer: true };

  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\code\code-block.ts
  var CodeBlock = class {
    constructor(element) {
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\code\index.ts
  var Code = class {
    run() {
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\docs\catalog.ts
  var Catalog = class {
    run() {
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\docs\index.ts
  var Docs = class {
    run() {
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\font-size-selector\index.ts
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\form-validator\index.ts
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\iframe\index.ts
  var IFrame = class {
    run() {
      this.load();
      this.fullscreen();
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\loading-bar\index.ts
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\scroller\index.ts
  var Scroller = class {
    constructor() {
      __publicField(this, "btn");
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\sidebar-toggle\index.ts
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\table-wrapper\index.ts
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\toc\index.ts
  var TOC = class {
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\main\js\components.ts
  var components = [];
  var components_default = components;

  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\slide\index.ts
  (() => {
    "use strict";
  ...
  // ns-hugo:E:\blog\themes\hugo-theme-bootstrap\assets\js\search\index.ts
  (() => {
    "use strict";
    var _a, _b;
