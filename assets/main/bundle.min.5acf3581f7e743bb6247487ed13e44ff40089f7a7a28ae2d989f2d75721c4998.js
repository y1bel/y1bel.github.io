(() => {
  ...
  var params_default = { analytics: null, archive: { paginate: 20 }, backgroundimage: ["/images/bg-light.webp", "/images/eclipse.png"], baseURL: "http://localhost:1313/", brand: "Yibel's Blog", breadcrumb: true, breadcrumbdivider: "\u25B7", carouselpostcount: 5, codeblock: { linenos: false }, color: "auto", contact: { endpoint: "https://getform.io/f/56041c81-9e03-4c24-b9c5-61238854d4cd" }, counttaxonomyposts: true, creativecommons: null, customcss: null, customjs: null, dateformat: ":date_long", description: "Yibel's personal blog", diagram: true, featuredpostcount: 5, fixedheader: true, fontsize: null, fullwidth: false, giscus, googleadsense: null, keywords: "Record, Blog", logo: "images/logo.webp", mainsections: ["blog", "posts", "news"], palette: "lightblue", palettes: ["lightblue", "blue-gray", "brown", "cyan", "green", "indigo", "orange", "lightpink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 3, post: { featuredimage: true, numberifyheadings: true, numberifyheadingsseparator: "." }, postdate: true, poweredby: true, pwa: { manifest: { short_name: "Yibel's Blog" } }, readingtime: true, recentpostcount: 5, relatedpostcount: 5, repo: { branch: "main", url: "https://github.com/razonyang/hugo-theme-bootstrap-skeleton" }, reward: { alipay: "images/reward/alipay.png", wechat: "images/reward/wechat.png" }, search: { fuse: { threshold: 0.1 }, paginate: 5 }, searchbar: true, sidebar: null, sidebartaxonomies: ["series", "categories", "tags", "authors"], siteverification: { baidu: null, baiduunion: null, bing: null, google: null, shenma: null, so: null, sogou: null }, social: { email: "user@domain.tld", github: "https://github.com/y1bel" }, taxonomypaginate: 10, taxonomypostcount: 10, titlecase: true, titleseparator: "|", tocwordcount: 100, topappbar: { social: { github: "https://github.com/y1bel", patreon: null, paypal: null } }, viewer: true };
